...
public class DanceFloorBarrier implements DanceFloor {
  ...
  /**
   * Resets the dance floor for the next dancers.
   * Only one thread is allowed to call this method
   */
  private void finish() {
  ...
  /**
   * Error handling. Exists the program if called
   *
   * @param errMessage message to print out
   */
